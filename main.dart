...
class _StockPriceChartState extends State<StockPriceChart> {
  ...
  Future<void> loadStockPrices() async {
    final response = await http.get(
        Uri.parse(
            'https://api.polygon.io/v2/aggs/ticker/J/range/1/day/2023-01-09/2023-02-09?adjusted=true&sort=asc&limit=120&apiKey=9BXzWPmgc2mFeNgLDfl7sc8q8UOOsx1w'));
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Gagal memuat harga saham');
    }
  }
